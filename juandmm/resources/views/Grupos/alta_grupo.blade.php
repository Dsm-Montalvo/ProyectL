        ...
        <div class="container">
                        ...
                        <div class="offcanvas-body">
                            <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                                ...
                                <li class="nav-item">
                                    ...
                                    <meta http-equiv="Refresh" content="0;URL={{ route('lista_alumnos') }}">
                                    @else
            ...
            <form action="{{ route('registrar_grup')}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-floating mb-3">  
                    <input class="form-control" type="input" name="clave" value="{{old('clave')}}" id="floatingClave" placeholder="Ejepmlo: DSM-41" aria-describedby="ClaveHelp">
                ...
                <div class="form-floating mb-3">
                    <input class="form-control" type="input" name="nombre" value="{{old('nombre')}}" id="floatingNombre" placeholder="Ejemplo: Desarrollo de software Multiplataforma" aria-describedby="NombreHelp">
